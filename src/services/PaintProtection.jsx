          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl mb-8 text-gray-300 leading-relaxed">
                Dr. Tint & Wrap is a leading and trusted automotive service provider that specializes in offering top-notch paint protection film (PPF) services in the regions of Hamilton, Auckland, Rotorua, and Tauranga. Keep your vehicle looking pristine for longer by applying a high-durability clear film that goes unnoticed, preserving the paint's original high gloss finish. Protect your investment and protect the resale value of your vehicle. With our expertise and commitment to excellence, we ensure that your vehicle's paintwork remains pristine and protected from various elements, such as 24/7 protection from stone chips, bug damage, road tar, bird droppings, outdoor weathering, day-to-day scratches, and environmental damage. At Dr. Tint & Wrap, our skilled technicians utilize high-quality PPF materials and cutting-edge techniques to ensure a seamless and durable application, providing you with long-lasting protection for your vehicle's exterior
              </p>
